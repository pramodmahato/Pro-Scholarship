...
<head>
    ...
    <!-- Title  -->
    <title>XYZ National Scholarship Program</title>
                ...
                <div class="row h-100">
                    <div class="col-12 h-100">
                        <div class="h-100 d-md-flex justify-content-between align-items-center">
                            ...
                            <p>For Queries Call Us On: <span><a href="tel:+919814072323">+91-9814072323</a></span></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-8">
                    <div class="contact-form">
                        <h5 class="mb-50" align="center"><br>Log In</h5>
                        ...
                        <form action="check.php" method="post">
                            ...
                            <div class="form-group">
                                <input type="password" name="password" class="form-control" id="contact-password" placeholder="Password">
                            </div>
                            
                            <button type="submit" class="btn medilife-btn">LOG IN <span>+</span></button>

                        </form><br
                        <a href="forgot.php"><button class="btn medilife-btn">FORGOT PASSWORD <span>?</span></button></a>
                    </div>
                </div>
