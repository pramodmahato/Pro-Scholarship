            ...
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="form-sample" action="sign.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      if(empty($filepath))
                      {
                        echo "<input type='file' name='Sign' placeholder='Upload Signature'>";
                      }
                      else{
...
if(isset($_POST['btn_upload']))
{
  ...
  $filepath = "uploads/sign/".$email."".$filename;

  
  move_uploaded_file($filetmp,$filepath);

 $sql = "UPDATE users SET Sign='$filepath' where email='$email'" ;
