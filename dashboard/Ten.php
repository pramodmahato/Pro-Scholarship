                ...
                <div class="card-body">
                  ...
                  <form class="form-sample" action="Ten.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      if(empty($filepath))
                      {
                        echo "<input type='file' name='Ten' placeholder='Upload 10th Marksheet'>";
                      }
                      else{
...
{
  $filetmp = $_FILES["Ten"]["tmp_name"];
  $filename = $_FILES["Ten"]["name"];
  $filepath = "uploads/TenMark/".$email."".$filename;

  
  move_uploaded_file($filetmp,$filepath);

 $sql = "UPDATE users SET Ten='$filepath' where email='$email'" ;
