            ...
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="form-sample" action="photo.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      if(empty($filepath))
                      {
                        echo "<input type='file' name='passport' placeholder='Upload Photo'>";
                      }
                      else{
...
if(isset($_POST['btn_upload']))
{
  ...
  $filepath = "uploads/images/".$email."".$filename;

  
  move_uploaded_file($filetmp,$filepath);

 $sql = "UPDATE users SET Photo='$filepath' where email='$email'" ;
