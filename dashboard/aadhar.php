            ...
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="form-sample" action="aadhar.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      if(empty($filepath))
                      {
                        echo "<input type='file' name='Card' placeholder='Upload Aadhar Card'>";
                      }
                      else{
...
{
  $filetmp = $_FILES["Card"]["tmp_name"];
  $filename = $_FILES["Card"]["name"];
  $filepath = "uploads/aadhar/".$email."".$filename;

  
  move_uploaded_file($filetmp,$filepath);

 $sql = "UPDATE users SET Card='$filepath' where email='$email'" ;
