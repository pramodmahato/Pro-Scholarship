...
$filepath=$row['Photo'];
                      ...
                      $filepath3=$row['Card'];
                      $filepath4=$row['Ten'];
                      $filepath5=$row['Twelve'];


/*
echo "<table id='details' class='details' align='center' style='border-radius:8px;border:solid white 1px;'>
<tr>
<th> &nbsp; &nbsp; Query_ID &nbsp;&nbsp;</th>
<th> &nbsp; &nbsp; Name</th>
<th>Email</th>
...
echo "<td><div id='".$n."' class='popup'><button id='".$n."' style='background-color:blue;color:white;border-radius:5px;' onclick='popme(this.id)'>Reply</button>
  ...
  <br/>
    <textarea style='background: #e5f5f5;'></textarea>
  <br/>
  <input type='submit'/>
  </form>
...
<button id='".$n."' style='background-color:red;color:white;border-radius:5px;' onclick='myFunction(this.id)'>Delete</button></td>";
echo "</tr>";
$n++;
}
echo "</table>";
                ...
                <div class="card-body">
                  ...
                  <form class="form-sample" >
                    ...
                    <div class="form-group">
                      ...
                      if(empty($filepath))
                      {
                        echo "<a href='photo.php' target='_blank'><input type='button' class='btn btn-gradient-primary btn-rounded btn-fw' value='GO TO UPLOAD'></input></a>";
                      }
                      else{
                    ...
                    <div class="form-group">
                      ...
                      if(empty($filepath2))
                      {
                        echo "<a href='sign.php' target='_blank'><input type='button' class='btn btn-gradient-primary btn-rounded btn-fw' value='GO TO UPLOAD'></input></a>";
                      }
                      else{
                        echo "<img src='$filepath2' height='200px'></img><br>";
                      }
                      ?>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      if(empty($filepath3))
                      {
                        echo "<a href='aadhar.php' target='_blank'><input type='button' class='btn btn-gradient-primary btn-rounded btn-fw' value='GO TO UPLOAD'></input></a>";
                      }
                      else{
                        echo "<img src='$filepath3' height='200px'></img><br>";
                      }
                      ?>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      if(empty($filepath4))
                      {
                        echo "<a href='Ten.php' target='_blank'><input type='button' class='btn btn-gradient-primary btn-rounded btn-fw' value='GO TO UPLOAD'></input></a>";
                      }
                      else{
                        echo "<img src='$filepath4' height='200px'></img><br>";
                      }
                      ?>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      if(empty($filepath5))
                      {
                        echo "<a href='Twelve.php' target='_blank'><input type='button' class='btn btn-gradient-primary btn-rounded btn-fw' value='GO TO UPLOAD'></input></a>";
                      }
                      else{
                        echo "<img src='$filepath5' height='200px'></img><br>";
                      }
                      ?>
                      </div>
                    </div>
                    <a href="plans.php">
                       <input type="button" class="btn btn-gradient-primary btn-rounded btn-fw" value="NEXT"></button></a>
                    </div>
                  </form>
